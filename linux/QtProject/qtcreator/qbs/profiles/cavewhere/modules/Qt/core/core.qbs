...
Module {
    ...
    property stringList dynamicLibsDebug: ["pthread"]
    ...
    property string libFilePathDebug: "/opt/Qt/5.5/gcc_64/lib/libQt5Core.so.5.5.0"
    property string libFilePathRelease: "/opt/Qt/5.5/gcc_64/lib/libQt5Core.so.5.5.0"
    ...
    cpp.includePaths: {
        var paths = ["/opt/Qt/5.5/gcc_64/include", "/opt/Qt/5.5/gcc_64/include/QtCore"];
